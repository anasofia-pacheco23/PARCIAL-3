import {FormEditProducts} from "../../components/export";
...
class Home extends HTMLElement {
	...
	async render() {
		...
		appState.disco.forEach((disco: any) => {
            const discoContainer = this.ownerDocument.createElement("form-edit-products") as FormEditProducts;
...
customElements.define('screen-modify-products', Home);
export default Home;