import {FormAddProducts} from "../../components/export";
...
class Home extends HTMLElement {
	...
	async render() {
		...
		appState.disco.forEach((disco: any) => {
            const discoContainer = this.ownerDocument.createElement("form-add-products") as FormAddProducts;
...
customElements.define('screen-add-products', Home);
export default Home;